...
import com.trungkieu.mycalendar.helper.getAllTimeZones
...
data class EventEntity(
    ...
    @ColumnInfo(name = "repeat_limit") var repeatLimit: Long = 0,
    ...
    fun addIntervalTime(original: EventEntity) {
    ...
    private fun addMonthsWithSameDay(currStart: DateTime, original: EventEntity): DateTime {
    ...
    private fun addXthDayInterval(currStart: DateTime, original: EventEntity, forceLastWeekday: Boolean): DateTime {
