...
import com.trungkieu.mycalendar.databinding.MonthViewBackgroundBinding
import com.trungkieu.mycalendar.databinding.MonthViewBinding
...
class MonthViewWrapper(context: Context, attrs: AttributeSet, defStyle: Int) : FrameLayout(context, attrs, defStyle) {
    ...
    override fun onLayout(changed: Boolean, left: Int, top: Int, right: Int, bottom: Int) {
        ...
        for (i in 0 until childCount) {
            ...
            /** repairing here*/
//            child.setBackgroundColor(context.getColor(R.color.white))
