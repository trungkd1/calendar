...
class MonthViewBackUp(context: Context, attrs: AttributeSet, defStyle: Int) : View(context, attrs, defStyle) {
...
//        primaryColor = context.getProperPrimaryColor()
        primaryColor = context.getColor(com.simplemobiletools.commons.R.color.md_light_blue)
        /**done*/
//        textColor = context.getProperTextColor()
        textColor = context.getColor(R.color.red_text)
